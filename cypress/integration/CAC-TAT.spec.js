...
describe('Central de Atendimento ao Cliente TAT', function () {
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
    ...
    cy.get('#lastName')
      .type('Midori')
      .should('have.value', 'Midori')
      .clear()
      .should('have.value', '')
    cy.get('#email')
      .type('patriciamidori@mail.com')
      .should('have.value', 'patriciamidori@mail.com')
      .clear()
      .should('have.value', '')
    cy.get('#phone')
      .type('1234567890')
  ...
  it('marca o tipo de atendimento "Feedback"', function () {
    cy.get('[type="radio"]')
      .check('feedback')
      .should('have.value', 'feedback')      // meu código

    // cy.get('input[type="radio"][value = "feedback"]')
    //.check()
    //.should('have.value', 'feedback')    código Walmir: 
  })
